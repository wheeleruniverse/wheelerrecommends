...
//        if(($file = fopen("/var/task/imdb.csv", "r")) !== FALSE){ // TODO: update
        if(($file = fopen("imdb.csv", "r")) !== FALSE){ // TODO: update
...
//            echo "<img src='/assets/img/$id.jpg' onerror=\"this.onerror=null;this.src='noposter.jpg';\" />"; // TODO: update
            echo "<img src='noposter.jpg' />";
...
//        include "/var/task/title.php"; // TODO: update
        include "title.php";
    }
            ...
            <div class="flex">
                <div id="brand-logo" >
                    <a href="https://wheelerrecommends.com">
                        <img src="favicon.jpg" /> <!-- TODO: update -->
                    </a>
                </div>
                <div id="brand-name">
